...
inline const char *espcontrol_i18n_cs(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "po";
  if (std::strcmp(text, "Tue") == 0) return "út";
  if (std::strcmp(text, "Wed") == 0) return "st";
  if (std::strcmp(text, "Thu") == 0) return "čt";
  if (std::strcmp(text, "Fri") == 0) return "pá";
  if (std::strcmp(text, "Sat") == 0) return "so";
  if (std::strcmp(text, "Sun") == 0) return "ne";
...
inline const char *espcontrol_i18n_da(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "man";
  if (std::strcmp(text, "Tue") == 0) return "tir";
  if (std::strcmp(text, "Wed") == 0) return "ons";
  if (std::strcmp(text, "Thu") == 0) return "tor";
  if (std::strcmp(text, "Fri") == 0) return "fre";
  if (std::strcmp(text, "Sat") == 0) return "lør";
  if (std::strcmp(text, "Sun") == 0) return "søn";
...
inline const char *espcontrol_i18n_de(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "Mo";
  if (std::strcmp(text, "Tue") == 0) return "Di";
  if (std::strcmp(text, "Wed") == 0) return "Mi";
  if (std::strcmp(text, "Thu") == 0) return "Do";
  if (std::strcmp(text, "Fri") == 0) return "Fr";
  if (std::strcmp(text, "Sat") == 0) return "Sa";
  if (std::strcmp(text, "Sun") == 0) return "So";
...
inline const char *espcontrol_i18n_es(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "lun";
  if (std::strcmp(text, "Tue") == 0) return "mar";
  if (std::strcmp(text, "Wed") == 0) return "mié";
  if (std::strcmp(text, "Thu") == 0) return "jue";
  if (std::strcmp(text, "Fri") == 0) return "vie";
  if (std::strcmp(text, "Sat") == 0) return "sáb";
  if (std::strcmp(text, "Sun") == 0) return "dom";
...
inline const char *espcontrol_i18n_fi(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "Ma";
  if (std::strcmp(text, "Tue") == 0) return "Ti";
  if (std::strcmp(text, "Wed") == 0) return "Ke";
  if (std::strcmp(text, "Thu") == 0) return "To";
  if (std::strcmp(text, "Fri") == 0) return "Pe";
  if (std::strcmp(text, "Sat") == 0) return "La";
  if (std::strcmp(text, "Sun") == 0) return "Su";
...
inline const char *espcontrol_i18n_fr(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "lun";
  if (std::strcmp(text, "Tue") == 0) return "mar";
  if (std::strcmp(text, "Wed") == 0) return "mer";
  if (std::strcmp(text, "Thu") == 0) return "jeu";
  if (std::strcmp(text, "Fri") == 0) return "ven";
  if (std::strcmp(text, "Sat") == 0) return "sam";
  if (std::strcmp(text, "Sun") == 0) return "dim";
...
inline const char *espcontrol_i18n_he(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "ב׳";
  if (std::strcmp(text, "Tue") == 0) return "ג׳";
  if (std::strcmp(text, "Wed") == 0) return "ד׳";
  if (std::strcmp(text, "Thu") == 0) return "ה׳";
  if (std::strcmp(text, "Fri") == 0) return "ו׳";
  if (std::strcmp(text, "Sat") == 0) return "ש׳";
  if (std::strcmp(text, "Sun") == 0) return "א׳";
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "הוסיפו את המכשיר ב-Home Assistant\nכדי לאפשר שליטה";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "אשרו למכשיר לבצע\nפעולות ב-Home Assistant";
...
inline const char *espcontrol_i18n_hu(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "H";
  if (std::strcmp(text, "Tue") == 0) return "K";
  if (std::strcmp(text, "Wed") == 0) return "Sze";
  if (std::strcmp(text, "Thu") == 0) return "Cs";
  if (std::strcmp(text, "Fri") == 0) return "P";
  if (std::strcmp(text, "Sat") == 0) return "Szo";
  if (std::strcmp(text, "Sun") == 0) return "V";
...
inline const char *espcontrol_i18n_it(const char *text) {
  ...
  if (std::strcmp(text, "Tue") == 0) return "Mar";
  if (std::strcmp(text, "Wed") == 0) return "Mer";
  if (std::strcmp(text, "Thu") == 0) return "Gio";
  if (std::strcmp(text, "Fri") == 0) return "Ven";
  if (std::strcmp(text, "Sat") == 0) return "Sab";
  if (std::strcmp(text, "Sun") == 0) return "Dom";
...
inline const char *espcontrol_i18n_nl(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "ma";
  if (std::strcmp(text, "Tue") == 0) return "di";
  if (std::strcmp(text, "Wed") == 0) return "wo";
  if (std::strcmp(text, "Thu") == 0) return "do";
  if (std::strcmp(text, "Fri") == 0) return "vr";
  if (std::strcmp(text, "Sat") == 0) return "za";
  if (std::strcmp(text, "Sun") == 0) return "zo";
...
inline const char *espcontrol_i18n_pl(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "pon";
  if (std::strcmp(text, "Tue") == 0) return "wt";
  if (std::strcmp(text, "Wed") == 0) return "śr";
  if (std::strcmp(text, "Thu") == 0) return "czw";
  if (std::strcmp(text, "Fri") == 0) return "pt";
  if (std::strcmp(text, "Sat") == 0) return "sob";
  if (std::strcmp(text, "Sun") == 0) return "ndz";
...
inline const char *espcontrol_i18n_pt_br(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "seg";
  if (std::strcmp(text, "Tue") == 0) return "ter";
  if (std::strcmp(text, "Wed") == 0) return "qua";
  if (std::strcmp(text, "Thu") == 0) return "qui";
  if (std::strcmp(text, "Fri") == 0) return "sex";
  if (std::strcmp(text, "Sat") == 0) return "sáb";
  if (std::strcmp(text, "Sun") == 0) return "dom";
...
inline const char *espcontrol_i18n_ro(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "Lun";
  if (std::strcmp(text, "Tue") == 0) return "Mar";
  if (std::strcmp(text, "Wed") == 0) return "Mie";
  if (std::strcmp(text, "Thu") == 0) return "Joi";
  if (std::strcmp(text, "Fri") == 0) return "Vin";
  if (std::strcmp(text, "Sat") == 0) return "Sâm";
  if (std::strcmp(text, "Sun") == 0) return "Dum";
...
inline const char *espcontrol_i18n_ru(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "Пн";
  if (std::strcmp(text, "Tue") == 0) return "Вт";
  if (std::strcmp(text, "Wed") == 0) return "Ср";
  if (std::strcmp(text, "Thu") == 0) return "Чт";
  if (std::strcmp(text, "Fri") == 0) return "Пт";
  if (std::strcmp(text, "Sat") == 0) return "Сб";
  if (std::strcmp(text, "Sun") == 0) return "Вс";
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Добавьте это устройство в Home Assistant,\nчтобы включить управление";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Разрешите этому устройству выполнять\nдействия Home Assistant";
...
inline const char *espcontrol_i18n_sk(const char *text) {
  ...
  if (std::strcmp(text, "December") == 0) return "december";
  if (std::strcmp(text, "Mon") == 0) return "po";
  if (std::strcmp(text, "Tue") == 0) return "ut";
  if (std::strcmp(text, "Wed") == 0) return "st";
  if (std::strcmp(text, "Thu") == 0) return "št";
  if (std::strcmp(text, "Fri") == 0) return "pi";
  if (std::strcmp(text, "Sat") == 0) return "so";
  if (std::strcmp(text, "Sun") == 0) return "ne";
...
inline const char *espcontrol_i18n_sl(const char *text) {
  ...
  if (std::strcmp(text, "October") == 0) return "Oktober";
  if (std::strcmp(text, "Mon") == 0) return "Pon";
  if (std::strcmp(text, "Tue") == 0) return "Tor";
  if (std::strcmp(text, "Wed") == 0) return "Sre";
  if (std::strcmp(text, "Thu") == 0) return "Čet";
  if (std::strcmp(text, "Fri") == 0) return "Pet";
  if (std::strcmp(text, "Sat") == 0) return "Sob";
  if (std::strcmp(text, "Sun") == 0) return "Ned";
...
inline const char *espcontrol_i18n_sv(const char *text) {
  ...
  if (std::strcmp(text, "November") == 0) return "november";
  if (std::strcmp(text, "December") == 0) return "december";
  if (std::strcmp(text, "Mon") == 0) return "mån";
  if (std::strcmp(text, "Tue") == 0) return "tis";
  if (std::strcmp(text, "Wed") == 0) return "ons";
  if (std::strcmp(text, "Thu") == 0) return "tors";
  if (std::strcmp(text, "Fri") == 0) return "fre";
  if (std::strcmp(text, "Sat") == 0) return "lör";
  if (std::strcmp(text, "Sun") == 0) return "sön";
...
inline const char *espcontrol_i18n_tr(const char *text) {
  ...
  if (std::strcmp(text, "Mon") == 0) return "Pzt";
  if (std::strcmp(text, "Tue") == 0) return "Sal";
  if (std::strcmp(text, "Wed") == 0) return "Çar";
  if (std::strcmp(text, "Thu") == 0) return "Per";
  if (std::strcmp(text, "Fri") == 0) return "Cum";
  if (std::strcmp(text, "Sat") == 0) return "Cmt";
  if (std::strcmp(text, "Sun") == 0) return "Paz";
...
inline const char *espcontrol_i18n_uk(const char *text) {
  ...
  if (std::strcmp(text, "Fri") == 0) return "Пт";
  if (std::strcmp(text, "Sat") == 0) return "Сб";
  if (std::strcmp(text, "Sun") == 0) return "Нд";
...
inline const char *espcontrol_i18n_key_en(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Mon";
  if (std::strcmp(key, "tue") == 0) return "Tue";
  if (std::strcmp(key, "wed") == 0) return "Wed";
  if (std::strcmp(key, "thu") == 0) return "Thu";
  if (std::strcmp(key, "fri") == 0) return "Fri";
  if (std::strcmp(key, "sat") == 0) return "Sat";
  if (std::strcmp(key, "sun") == 0) return "Sun";
...
inline const char *espcontrol_i18n_key_cs(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "po";
  if (std::strcmp(key, "tue") == 0) return "út";
  if (std::strcmp(key, "wed") == 0) return "st";
  if (std::strcmp(key, "thu") == 0) return "čt";
  if (std::strcmp(key, "fri") == 0) return "pá";
  if (std::strcmp(key, "sat") == 0) return "so";
  if (std::strcmp(key, "sun") == 0) return "ne";
...
inline const char *espcontrol_i18n_key_da(const char *key) {
  ...
  if (std::strcmp(key, "november") == 0) return "november";
  if (std::strcmp(key, "december") == 0) return "december";
  if (std::strcmp(key, "mon") == 0) return "man";
  if (std::strcmp(key, "tue") == 0) return "tir";
  if (std::strcmp(key, "wed") == 0) return "ons";
  if (std::strcmp(key, "thu") == 0) return "tor";
  if (std::strcmp(key, "fri") == 0) return "fre";
  if (std::strcmp(key, "sat") == 0) return "lør";
  if (std::strcmp(key, "sun") == 0) return "søn";
...
inline const char *espcontrol_i18n_key_de(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Mo";
  if (std::strcmp(key, "tue") == 0) return "Di";
  if (std::strcmp(key, "wed") == 0) return "Mi";
  if (std::strcmp(key, "thu") == 0) return "Do";
  if (std::strcmp(key, "fri") == 0) return "Fr";
  if (std::strcmp(key, "sat") == 0) return "Sa";
  if (std::strcmp(key, "sun") == 0) return "So";
...
inline const char *espcontrol_i18n_key_es(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "lun";
  if (std::strcmp(key, "tue") == 0) return "mar";
  if (std::strcmp(key, "wed") == 0) return "mié";
  if (std::strcmp(key, "thu") == 0) return "jue";
  if (std::strcmp(key, "fri") == 0) return "vie";
  if (std::strcmp(key, "sat") == 0) return "sáb";
  if (std::strcmp(key, "sun") == 0) return "dom";
...
inline const char *espcontrol_i18n_key_fi(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Ma";
  if (std::strcmp(key, "tue") == 0) return "Ti";
  if (std::strcmp(key, "wed") == 0) return "Ke";
  if (std::strcmp(key, "thu") == 0) return "To";
  if (std::strcmp(key, "fri") == 0) return "Pe";
  if (std::strcmp(key, "sat") == 0) return "La";
  if (std::strcmp(key, "sun") == 0) return "Su";
...
inline const char *espcontrol_i18n_key_fr(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "lun";
  if (std::strcmp(key, "tue") == 0) return "mar";
  if (std::strcmp(key, "wed") == 0) return "mer";
  if (std::strcmp(key, "thu") == 0) return "jeu";
  if (std::strcmp(key, "fri") == 0) return "ven";
  if (std::strcmp(key, "sat") == 0) return "sam";
  if (std::strcmp(key, "sun") == 0) return "dim";
...
inline const char *espcontrol_i18n_key_he(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "ב׳";
  if (std::strcmp(key, "tue") == 0) return "ג׳";
  if (std::strcmp(key, "wed") == 0) return "ד׳";
  if (std::strcmp(key, "thu") == 0) return "ה׳";
  if (std::strcmp(key, "fri") == 0) return "ו׳";
  if (std::strcmp(key, "sat") == 0) return "ש׳";
  if (std::strcmp(key, "sun") == 0) return "א׳";
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "הוסיפו את המכשיר ב-Home Assistant\nכדי לאפשר שליטה";
...
inline const char *espcontrol_i18n_key_hu(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "H";
  if (std::strcmp(key, "tue") == 0) return "K";
  if (std::strcmp(key, "wed") == 0) return "Sze";
  if (std::strcmp(key, "thu") == 0) return "Cs";
  if (std::strcmp(key, "fri") == 0) return "P";
  if (std::strcmp(key, "sat") == 0) return "Szo";
  if (std::strcmp(key, "sun") == 0) return "V";
...
inline const char *espcontrol_i18n_key_it(const char *key) {
  ...
  if (std::strcmp(key, "tue") == 0) return "Mar";
  if (std::strcmp(key, "wed") == 0) return "Mer";
  if (std::strcmp(key, "thu") == 0) return "Gio";
  if (std::strcmp(key, "fri") == 0) return "Ven";
  if (std::strcmp(key, "sat") == 0) return "Sab";
  if (std::strcmp(key, "sun") == 0) return "Dom";
...
inline const char *espcontrol_i18n_key_nl(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "ma";
  if (std::strcmp(key, "tue") == 0) return "di";
  if (std::strcmp(key, "wed") == 0) return "wo";
  if (std::strcmp(key, "thu") == 0) return "do";
  if (std::strcmp(key, "fri") == 0) return "vr";
  if (std::strcmp(key, "sat") == 0) return "za";
  if (std::strcmp(key, "sun") == 0) return "zo";
...
inline const char *espcontrol_i18n_key_pl(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "pon";
  if (std::strcmp(key, "tue") == 0) return "wt";
  if (std::strcmp(key, "wed") == 0) return "śr";
  if (std::strcmp(key, "thu") == 0) return "czw";
  if (std::strcmp(key, "fri") == 0) return "pt";
  if (std::strcmp(key, "sat") == 0) return "sob";
  if (std::strcmp(key, "sun") == 0) return "ndz";
...
inline const char *espcontrol_i18n_key_pt_br(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "seg";
  if (std::strcmp(key, "tue") == 0) return "ter";
  if (std::strcmp(key, "wed") == 0) return "qua";
  if (std::strcmp(key, "thu") == 0) return "qui";
  if (std::strcmp(key, "fri") == 0) return "sex";
  if (std::strcmp(key, "sat") == 0) return "sáb";
  if (std::strcmp(key, "sun") == 0) return "dom";
...
inline const char *espcontrol_i18n_key_ro(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Lun";
  if (std::strcmp(key, "tue") == 0) return "Mar";
  if (std::strcmp(key, "wed") == 0) return "Mie";
  if (std::strcmp(key, "thu") == 0) return "Joi";
  if (std::strcmp(key, "fri") == 0) return "Vin";
  if (std::strcmp(key, "sat") == 0) return "Sâm";
  if (std::strcmp(key, "sun") == 0) return "Dum";
...
inline const char *espcontrol_i18n_key_ru(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Пн";
  if (std::strcmp(key, "tue") == 0) return "Вт";
  if (std::strcmp(key, "wed") == 0) return "Ср";
  if (std::strcmp(key, "thu") == 0) return "Чт";
  if (std::strcmp(key, "fri") == 0) return "Пт";
  if (std::strcmp(key, "sat") == 0) return "Сб";
  if (std::strcmp(key, "sun") == 0) return "Вс";
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Добавьте это устройство в Home Assistant,\nчтобы включить управление";
...
inline const char *espcontrol_i18n_key_sk(const char *key) {
  ...
  if (std::strcmp(key, "december") == 0) return "december";
  if (std::strcmp(key, "mon") == 0) return "po";
  if (std::strcmp(key, "tue") == 0) return "ut";
  if (std::strcmp(key, "wed") == 0) return "st";
  if (std::strcmp(key, "thu") == 0) return "št";
  if (std::strcmp(key, "fri") == 0) return "pi";
  if (std::strcmp(key, "sat") == 0) return "so";
  if (std::strcmp(key, "sun") == 0) return "ne";
...
inline const char *espcontrol_i18n_key_sl(const char *key) {
  ...
  if (std::strcmp(key, "october") == 0) return "Oktober";
  if (std::strcmp(key, "mon") == 0) return "Pon";
  if (std::strcmp(key, "tue") == 0) return "Tor";
  if (std::strcmp(key, "wed") == 0) return "Sre";
  if (std::strcmp(key, "thu") == 0) return "Čet";
  if (std::strcmp(key, "fri") == 0) return "Pet";
  if (std::strcmp(key, "sat") == 0) return "Sob";
  if (std::strcmp(key, "sun") == 0) return "Ned";
...
inline const char *espcontrol_i18n_key_sv(const char *key) {
  ...
  if (std::strcmp(key, "november") == 0) return "november";
  if (std::strcmp(key, "december") == 0) return "december";
  if (std::strcmp(key, "mon") == 0) return "mån";
  if (std::strcmp(key, "tue") == 0) return "tis";
  if (std::strcmp(key, "wed") == 0) return "ons";
  if (std::strcmp(key, "thu") == 0) return "tors";
  if (std::strcmp(key, "fri") == 0) return "fre";
  if (std::strcmp(key, "sat") == 0) return "lör";
  if (std::strcmp(key, "sun") == 0) return "sön";
...
inline const char *espcontrol_i18n_key_tr(const char *key) {
  ...
  if (std::strcmp(key, "mon") == 0) return "Pzt";
  if (std::strcmp(key, "tue") == 0) return "Sal";
  if (std::strcmp(key, "wed") == 0) return "Çar";
  if (std::strcmp(key, "thu") == 0) return "Per";
  if (std::strcmp(key, "fri") == 0) return "Cum";
  if (std::strcmp(key, "sat") == 0) return "Cmt";
  if (std::strcmp(key, "sun") == 0) return "Paz";
...
inline const char *espcontrol_i18n_key_uk(const char *key) {
  ...
  if (std::strcmp(key, "fri") == 0) return "Пт";
  if (std::strcmp(key, "sat") == 0) return "Сб";
  if (std::strcmp(key, "sun") == 0) return "Нд";
