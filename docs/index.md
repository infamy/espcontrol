...
- **Display behaviour controls** - set brightness, idle timeout, screensaver mode, presence-based wake, camera wake on supported panels, clock bar, rotation, screen schedule, and before-clock-sync behaviour.
