...
Panels with the front camera can use it to wake the screen when someone moves in front of the panel. Choose **Camera** as the [Screensaver](/features/screensaver#camera) mode in Settings. Camera mode is available in the V2 / new panel firmware.
