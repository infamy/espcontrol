...
TASKS = (
    task("firmware-tests", ("cmake", "-E", "remove_directory", "build/tests/firmware"),
         ...
         inputs=(
             ...
             "components/espcontrol/panel_config_capabilities_endpoint.h",
             "components/espcontrol/panel_config_legacy_adapter.*",
             "components/espcontrol/panel_config_runtime_adapter.*",
             "components/espcontrol/panel_config_text_bindings.*",
             "components/espcontrol/panel_config_storage_backend.h",
             "components/espcontrol/panel_config_espidf_storage.*",
             ...
             "components/espcontrol/weather_days_forecast.h",
             ...
             "scripts/generate_climate_subscription_runtime_test.py",
    ...
    task("mutations", ("python3", "scripts/run_mutations.py"),
         ...
         inputs=("tests/mutations/**", "tests/firmware/**", "tests/web/*.test.ts", "tests/web/unit/**", "components/espcontrol/configuration_service.*", "components/espcontrol/panel_config_service_validator.h", "components/espcontrol/panel_config_legacy_adapter.*", "components/espcontrol/panel_config_runtime_adapter.*", "components/espcontrol/panel_config_text_bindings.*", "components/espcontrol/panel_config_storage_backend.h", "components/espcontrol/panel_config_espidf_storage.*", "components/espcontrol/configuration_store.*", "components/espcontrol/panel_config_document.h", "src/webserver/model/**", "src/webserver/generated/**", "scripts/run_mutations.py"),
         cache="never"),
    ...
    task("saved-config-production", ("node", "scripts/check_saved_config_production.js"), dependencies=("generated",), profiles=FAST,
         domains=("firmware", "web", "product"), inputs=("product/v2/card_contract.json", "components/espcontrol/button_grid_config_parser.h", "components/espcontrol/button_grid_saved_config_*_generated.h", "src/webserver/application/config_codec.ts", "src/webserver/cards/vacuum.ts", "src/webserver/generated/saved_config_*.ts", "scripts/check_saved_config_production.js"),
         parallel_safe=True, cache_tools=("c++", "g++", "clang++", "node")),
    ...
    task("release-contract", ("python3", "scripts/check_release_contract.py", "--self-test"),
         ...
         domains=("product", "firmware", "web", "workflow"), inputs=("product/release_contract.json", "product/model_v2.json", "devices/manifest.json", "components/espcontrol/panel_config_document.h", "components/espcontrol/panel_config_capabilities.h", "docs/public/webserver/web-assets.json", "scripts/check_release_contract.py"),
